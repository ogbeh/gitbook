---
description: >-
  Get started with Cone in just a few minutes. This guide covers installation,
  account creation, and connecting to your first server.
icon: bolt
coverY: 0
---
...
{% hint style="warning" %}
**iPhone / iPad, Linux, and routers require third-party apps (see** [**Advanced Setup**](advanced-setup/ios-iphone-and-ipad-setup-guide/)**).**
{% endhint %}
